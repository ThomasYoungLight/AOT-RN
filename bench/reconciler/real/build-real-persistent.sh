...
cat main-real-persistent-body.js >> entry.cjs

npx esbuild entry.cjs --bundle --platform=neutral --format=iife \
  --define:process.env.NODE_ENV='"production"' \
  --define:__DEV__=false \
  --outfile=real-react-persistent-bundle.js
echo "built real-react-persistent-bundle.js ($(wc -c < real-react-persistent-bundle.js) bytes)"
